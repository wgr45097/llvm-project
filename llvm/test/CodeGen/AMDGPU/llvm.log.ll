...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v3, s11, v3
...
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e64 s[0:1], |v3|, s4
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v0, s10, v0
; GFX900-SDAG-NEXT:    v_log_f32_e32 v0, v0
...
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 1.0, v1, vcc
; VI-SDAG-NEXT:    v_mul_f32_e32 v2, s10, v2
; VI-SDAG-NEXT:    v_log_f32_e32 v2, v2
; VI-SDAG-NEXT:    v_and_b32_e32 v3, 0xfffff000, v2
; VI-SDAG-NEXT:    v_sub_f32_e32 v4, v2, v3
; VI-SDAG-NEXT:    v_mul_f32_e32 v5, 0x3805fdf4, v3
...
; VI-SDAG-NEXT:    v_mul_f32_e32 v0, s8, v0
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v2, s10, v2
...
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v2, s4, -v4
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v2, s5, v5
; GFX900-SDAG-NEXT:    v_add_f32_e32 v4, v4, v5
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v4, s9, v4
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v0, s8, v0
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v4, s4, -v6
; GFX900-SDAG-NEXT:    v_log_f32_e32 v0, v0
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v4, s5, v7
...
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v1, 1.0, 0x4f800000, s6
...
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v0, s2, v0 :: v_dual_mul_f32 v1, s1, v1
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, v0
; GFX1100-SDAG-NEXT:    v_mul_f32_e32 v2, s0, v2
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, v1
; GFX1100-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1100-SDAG-NEXT:    s_waitcnt_depctr 0xfff
...
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v2, 1.0, v1, vcc
; VI-SDAG-NEXT:    v_mul_f32_e32 v2, s11, v2
; VI-SDAG-NEXT:    v_log_f32_e32 v2, v2
; VI-SDAG-NEXT:    v_and_b32_e32 v3, 0xfffff000, v2
; VI-SDAG-NEXT:    v_sub_f32_e32 v4, v2, v3
; VI-SDAG-NEXT:    v_mul_f32_e32 v5, 0x3805fdf4, v3
...
; VI-SDAG-NEXT:    v_cndmask_b32_e64 v3, 1.0, v1, s[0:1]
; VI-SDAG-NEXT:    v_mul_f32_e32 v3, s10, v3
...
; VI-SDAG-NEXT:    v_mul_f32_e32 v6, s9, v6
; VI-SDAG-NEXT:    v_log_f32_e32 v6, v6
; VI-SDAG-NEXT:    v_cmp_lt_f32_e64 s[2:3], |v4|, s6
...
; VI-SDAG-NEXT:    v_cmp_lt_f32_e64 s[2:3], |v6|, s6
...
; GFX900-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s11, v0
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v2, 1.0, v1, vcc
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v2, s11, v2
; GFX900-SDAG-NEXT:    v_log_f32_e32 v2, v2
; GFX900-SDAG-NEXT:    s_mov_b32 s5, 0x3377d1cf
...
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v2, s4, -v3
; GFX900-SDAG-NEXT:    v_fma_f32 v5, v2, s5, v5
; GFX900-SDAG-NEXT:    v_add_f32_e32 v3, v3, v5
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v3, s10, v3
...
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v5, s4, -v2
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v5, s5, v7
; GFX900-SDAG-NEXT:    v_add_f32_e32 v2, v2, v7
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v7, 1.0, v1, vcc
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v7, s9, v7
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v0, s8, v0
; GFX900-SDAG-NEXT:    v_fma_f32 v8, v7, s4, -v5
; GFX900-SDAG-NEXT:    v_log_f32_e32 v0, v0
; GFX900-SDAG-NEXT:    v_fma_f32 v8, v7, s5, v8
...
; GFX900-SDAG-NEXT:    v_fma_f32 v7, v0, s4, -v5
...
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v0, 1.0, 0x4f800000, s6
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v1, 1.0, 0x4f800000, s7
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v0, s3, v0 :: v_dual_mul_f32 v1, s2, v1
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v2, s1, v2 :: v_dual_mul_f32 v3, s0, v3
; GFX1100-SDAG-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v0, v0
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v1, v1
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_4) | instid1(TRANS32_DEP_3)
; GFX1100-SDAG-NEXT:    v_log_f32_e32 v2, v2

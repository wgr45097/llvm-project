...
; GFX1132-DPP-NEXT:    s_endpgm
  %result = atomicrmw fmin ptr addrspace(1) %ptr, double 4.0 syncscope("agent") monotonic, align 4, !amdgpu.no.fine.grained.memory !1
  ret void
}
...
; GFX1132-DPP-NEXT:    s_endpgm
  ...
  %result = atomicrmw fmin ptr addrspace(1) %ptr, double %divValue syncscope("agent") monotonic, align 4, !amdgpu.no.fine.grained.memory !1
  ret void
}
...
; GFX1132-DPP-NEXT:    s_set_inst_prefetch_distance 0x2
; GFX1132-DPP-NEXT:    s_endpgm
  %result = atomicrmw fmin ptr addrspace(1) %ptr, double 4.0 monotonic, align 4, !amdgpu.no.fine.grained.memory !1
  ret void
}
...
; GFX1132-DPP-NEXT:    s_endpgm
  %divValue = call double @div.double.value()
  %result = atomicrmw fmin ptr addrspace(1) %ptr, double %divValue monotonic, align 4, !amdgpu.no.fine.grained.memory !1
  ret void
}

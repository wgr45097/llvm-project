...
; SI-SDAG-NEXT:    v_mul_f32_e32 v4, s1, v4
; SI-SDAG-NEXT:    v_mul_f32_e32 v0, s2, v0
; SI-SDAG-NEXT:    v_log_f32_e32 v4, v4
; SI-SDAG-NEXT:    v_mul_f32_e32 v6, s0, v6
...
; VI-SDAG-NEXT:    v_log_f32_e32 v4, v4
; VI-SDAG-NEXT:    v_mul_f32_e32 v6, s1, v6
...
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v4, s2, v4
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v6, s1, v6
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v1, s0, v1
; GFX900-SDAG-NEXT:    v_log_f32_e32 v4, v4
...
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v2, 1.0, 0x4f800000, s3
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v4, 1.0, 0x4f800000, s6
...
; GFX1100-SDAG-NEXT:    v_mul_f32_e32 v2, s2, v2
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v4, s1, v4 :: v_dual_mul_f32 v5, s0, v5
...
; VI-SDAG-NEXT:    v_cmp_lt_f32_e32 vcc, s0, v0
; VI-SDAG-NEXT:    v_mul_f32_e32 v4, s3, v4
; VI-SDAG-NEXT:    v_mul_f32_e32 v6, s2, v6
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; VI-SDAG-NEXT:    v_cndmask_b32_e32 v1, 1.0, v3, vcc
; VI-SDAG-NEXT:    v_log_f32_e32 v4, v4
; VI-SDAG-NEXT:    v_log_f32_e32 v6, v6
; VI-SDAG-NEXT:    v_mul_f32_e32 v8, s1, v8
; VI-SDAG-NEXT:    v_mul_f32_e32 v1, s0, v1
...
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v1, vcc
; GFX900-SDAG-NEXT:    v_cndmask_b32_e32 v1, 1.0, v3, vcc
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v5, s3, v5
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v7, s2, v7
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v9, s1, v9
; GFX900-SDAG-NEXT:    v_mul_f32_e32 v1, s0, v1
...
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v2, 1.0, 0x4f800000, s6
; GFX1100-SDAG-NEXT:    v_cndmask_b32_e64 v3, 1.0, 0x4f800000, s7
; GFX1100-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
...
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v2, s3, v2 :: v_dual_mul_f32 v3, s2, v3
; GFX1100-SDAG-NEXT:    v_dual_mul_f32 v6, s1, v6 :: v_dual_mul_f32 v7, s0, v7
